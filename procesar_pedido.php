        ...
        <div class="row">
            <div class="col-sm-8 col-md-8 col-lg-8 mx-auto">
                ...
                <form action="crear_pedido.php" method="POST" class="mt-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="metodo_pago" value="efectivo"
                                id="metodo_pago1" required>
                            <label class="form-check-label" for="metodo_pago1">Efectivo</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="metodo_pago" value="tarjeta"
                                id="metodo_pago2" required>
                            <label class="form-check-label" for="metodo_pago2">Tarjeta</label>
                        </div>
                    </div>

                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" value="1" id="flexCheckChecked" name="delivery"
                            checked>
                    ...
                    <input type="hidden" name="productos[]" value="<?php echo $index; ?>">
                    <!-- Índice o id del producto -->
                    <input type="hidden" name="cantidades[]" value="<?php echo $item['quantity']; ?>">
